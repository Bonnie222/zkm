              ...
              var headerData = {
                product: {
                  ...
                  list: [{
                    ...
                    desc: '低门槛商店,提高您的质量',
                    href: '#/product/mall',
                    icon: __uri('images/product-icon(1).svg')
                  }, {
                    name: '招客猫收银',
                    desc: '多种收银方式',
                    href: '#/product/cashier',
                    icon: __uri('images/product-icon(2).svg')
                  }, {
                    name: '招客猫新零售',
                    desc: '线上线下两不误',
                    href: '#/product/model',
                    icon: __uri('images/product-icon(3).svg')
                  }]
                },
                service: {
                  title: '服务',
                  list:[{
                    ...
                    icon: __uri('images/service-icon(1).svg')
                  }, {
                    name: '定制服务',
                    desc: '店铺装修,营销方案支持私人定制',
                    href: '#/service/service',
                    icon: __uri('images/service-icon(2).svg')
                  }, {
                    name: '广告投放 (暂未开放，敬请期待)',
                    desc: '链接优质流量,精准营销',
                    href: '',
                    icon: __uri('images/service-icon(3).svg')
                  }
                ]
                }
              };
              $('#top-header').html(_.template(__inline('templates/header/header.html'), headerData));
            },
            menuEvent: function() {
